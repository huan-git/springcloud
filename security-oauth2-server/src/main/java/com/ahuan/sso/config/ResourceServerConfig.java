...
import com.ahuan.sso.service.MyAuthenticationEntryPoint;
import com.ahuan.sso.service.RestAuthAccessDeniedHandler;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.requestMatchers().antMatchers("/user/getUserInfo")
                .and()
                .authorizeRequests()
