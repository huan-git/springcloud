...
public class OssUtil {
    ...
    public String getUrl(String key) {
        ...
        // 生成URL
        OSSClient ossClient = new OSSClient("oss-cn-beijing.aliyuncs.com", "LTAI4FpCK5xEYnMrJvFWa5iZ", "82cACiCF4VLdrIMmAHHtWqn6KVUr8s");
        URL url = ossClient.generatePresignedUrl("ahuan", key, expiration);
        if (url != null) {
            return url.toString();
        }
        return null;
    ...
    public static void main(String[] args) {
        ...
        ObjectListing objectListing = ossClient.listObjects("ahuan", "test");
