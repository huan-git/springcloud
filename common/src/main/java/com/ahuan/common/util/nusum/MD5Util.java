package com.ahuan.common.util.nusum;
...
public class MD5Util {
    ...
    public static void main(String[] args) {
        String encoderByMd5WithSalt = encoderByMd5WithSalt("123456");
        System.out.println(encoderByMd5WithSalt);
        System.out.println(verifyPwd("123456", encoderByMd5WithSalt));
